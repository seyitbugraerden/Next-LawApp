...
export const ContactForm = () => {
  return (
    <section className="mt-12 lg:py-6 lg:py-24 bg-tertiary overflow-y-hidden">
      <Container className="flex flex-col lg:flex-row lg:px-24 bg-transparent">
        ...
        <div className="flex-1 flex flex-col gap-6 p-4 lg:p-24 bg-secondary shadow-2xl shadow-black/70">
          ...
          <input
            ...
            placeholder="Adınız"
            required
            className="border border-white bg-transparent text-xs lg:text-sm focus:outline-none focus:border-white p-3 placeholder:text-white text-white"
          />
          <input
            type="email"
          ...
          <input
            ...
            className="border border-white bg-transparent text-xs lg:text-sm focus:outline-none focus:border-white p-3 placeholder:text-white text-white"
          />
          <select className="border border-white bg-transparent text-xs lg:text-sm focus:outline-none focus:border-white p-3 text-white">
